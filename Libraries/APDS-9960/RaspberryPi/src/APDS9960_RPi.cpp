/**
* @file    APDS9960_RPi.cpp
* @brief   Raspberry Pi library for the SparkFun APDS-9960 breakout board
* @author  Shawn Hymel (SparkFun Electronics), Modified for Raspberry Pi by Will Stull
*
...
*/
bool APDS9960_RPi::setMode(uint8_t mode, uint8_t enable)
{
	uint8_t reg_val;
...
*/
bool APDS9960_RPi::enableLightSensor(bool interrupts)
{
...
*/
bool APDS9960_RPi::disableLightSensor()
{
	if( !setAmbientLightIntEnable(0) ) {
		return false;
	}
...
* @return True if sensor enabled correctly. False on error.
*/
bool APDS9960_RPi::enableProximitySensor(bool interrupts)
{
...
*/
bool APDS9960_RPi::enableGestureSensor(bool interrupts)
{
...
*/
bool APDS9960_RPi::disableGestureSensor()
{
	resetGestureParameters();
	if( !setGestureIntEnable(0) ) {
		return false;
...
*/
bool APDS9960_RPi::isGestureAvailable()
{
	uint8_t val;
...
* @return True if operation successful. False otherwise.
*/
bool APDS9960_RPi::disablePower()
{
	if( !setMode(POWER, 0) ) {
		return false;
	}
...
* @return True if operation successful. False otherwise.
*/
bool APDS9960_RPi::readAmbientLight(uint16_t &val)
{
	uint8_t val_byte;
	val = 0;
...
* @return True if operation successful. False otherwise.
*/
bool APDS9960_RPi::readRedLight(uint16_t &val)
{
	uint8_t val_byte;
	val = 0;
...
* @return True if operation successful. False otherwise.
*/
bool APDS9960_RPi::readGreenLight(uint16_t &val)
{
	uint8_t val_byte;
	val = 0;
...
* @return True if operation successful. False otherwise.
*/
bool APDS9960_RPi::readBlueLight(uint16_t &val)
{
	uint8_t val_byte;
	val = 0;
...
* @return True if operation successful. False otherwise.
*/
bool APDS9960_RPi::readProximity(uint8_t &val)
{
	val = 0;
...
*/
void APDS9960_RPi::resetGestureParameters()
{
	gesture_data_.index = 0;
	gesture_data_.total_gestures = 0;
...
*/
bool APDS9960_RPi::processGestureData()
{
	uint8_t u_first = 0;
	uint8_t d_first = 0;
	uint8_t l_first = 0;
...
*/
bool APDS9960_RPi::decodeGesture()
{
...
*/
uint8_t APDS9960_RPi::getProxIntLowThresh()
{
	uint8_t val;
...
* @return True if operation successful. False otherwise.
*/
bool APDS9960_RPi::setProxIntLowThresh(uint8_t threshold)
{
...
*/
uint8_t APDS9960_RPi::getProxIntHighThresh()
{
	uint8_t val;
...
* @return True if operation successful. False otherwise.
*/
bool APDS9960_RPi::setGestureEnterThresh(uint8_t threshold)
{
...
*/
uint8_t APDS9960_RPi::getGestureExitThresh()
{
	uint8_t val;
...
* @return True if operation successful. False otherwise.
*/
bool APDS9960_RPi::setGestureExitThresh(uint8_t threshold)
{
...
*/
uint8_t APDS9960_RPi::getGestureGain()
{
	uint8_t val;
...
* @return True if operation successful. False otherwise.
*/
bool APDS9960_RPi::setGestureGain(uint8_t gain)
{
	uint8_t val;
...
*/
uint8_t APDS9960_RPi::getGestureLEDDrive()
{
	uint8_t val;
...
* @return True if operation successful. False otherwise.
*/
bool APDS9960_RPi::setGestureLEDDrive(uint8_t drive)
{
	uint8_t val;
...
*/
uint8_t APDS9960_RPi::getGestureWaitTime()
{
	uint8_t val;
...
* @return True if operation successful. False otherwise.
*/
bool APDS9960_RPi::setGestureWaitTime(uint8_t time)
{
	uint8_t val;
...
* @return True if operation successful. False otherwise.
*/
bool APDS9960_RPi::setGestureMode(uint8_t mode)
{
	uint8_t val;
...
*/
bool APDS9960_RPi::wireWriteByte(uint8_t val)
{    
...
* @return True if successful write operation. False otherwise.
*/
bool APDS9960_RPi::wireWriteDataByte(uint8_t reg, uint8_t val)
{
...
* @return True if successful write operation. False otherwise.
*/
bool APDS9960_RPi::wireWriteDataBlock(  uint8_t reg, 
                                    uint8_t *val, 
                                    unsigned int len)
{
...
*/
bool APDS9960_RPi::wireReadDataByte(uint8_t reg, uint8_t &val)
{
